...
$dictionary = [
	"EN" 	=> [
		...
		"font-2" => "https://fonts.googleapis.com/css2?family=Philosopher&display=swap",
		"logo-text" => "en-logo.svg",
		"logo" => "bricks-logo.svg",

		// Expressions
		//navbar
		"title" => "Three prodction house",
		"home" => "Home",
		"about" => "About",
		"services" => "Services",
		"clients" => "Clients",
		...
		//Home
		"caption" => "work with true experts",
		"caption-p" => "Strives to work with artistic minds and ambitious entrepreneurs in the industry.",
		"about-us" => "about us",
